...
public class TestSuite extends TopMenuTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //2.22 Fill the all mandatory field
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"), "Ruby");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_LastName']"), "Parmar");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Email']"), "RUbyy@gmail.com");
        selectByVisibleTextFromDropDown(By.xpath("//select[@id='BillingNewAddress_CountryId']"), "United Kingdom");
        selectByVisibleTextFromDropDown(By.xpath("//select[@id='BillingNewAddress_StateProvinceId']"), "UK");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"), "London");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Address1']"), "9,Plazma Street");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']"), "LN3 0TD");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']"), "07899643534");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"), "London");
        ...
        sendTextToElement(By.xpath("//input[@id='CardholderName']"), "Virat");
        ...
        sendTextToElement(By.xpath("//input[@id='CardCode']"), "674");
