...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='FirstName']"), "Sonia");
        sendTextToElement(By.xpath("//input[@id='LastName']"), "Mirza");
        sendTextToElement(By.xpath("//input[@id='Email']"), "Tarat123@gmail.com");
        sendTextToElement(By.xpath("//input[@id='Password']"), "453672");
        sendTextToElement(By.xpath("//input[@id='ConfirmPassword']"), "453672");
        //Thread.sleep(3000);
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Tara");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Suthar");
        sendTextToElement(By.xpath("//select[@id='BillingNewAddress_CountryId']"), "UK");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_City']"), "London");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Address1']"), "10,Kenmor Street");
        sendTextToElement(By.xpath("//select[@id='BillingNewAddress_StateProvinceId']"), "London");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']"), "HA7 2FP");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']"), "0797654321");
        ...
        sendTextToElement(By.xpath("//input[@id='CardholderName']"), "H T Suthar");
        ...
        sendTextToElement(By.xpath("//input[@id='CardCode']"), "738");
